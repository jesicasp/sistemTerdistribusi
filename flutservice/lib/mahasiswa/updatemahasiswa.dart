...
class _UpdateMahasiswaState extends State<UpdateMahasiswa> {
  ...
  String urlInsert = "http://10.0.2.2:9001/api/v1/mahasiswa/$id?nama=${nama.text}&email=${email.text}&tglLahir=${tglLahir.toLocal().toString().split(" ")[0]}";

  try {
    if (nama.text != null && email.text != null && tglLahir != null) {
